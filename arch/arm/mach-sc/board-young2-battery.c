...
#else
#define ADC_CHANNEL_TEMP        2		/* DCXO thermister - h/w request */
#endif
...
static sec_charging_current_t charging_current_table[] = {
	...
	{650,   650,    120,    20 * 60},     /* POWER_SUPPLY_TYPE_MAINS */
	{500,   500,    120,    20 * 60},     /* POWER_SUPPLY_TYPE_USB */
	...
	{650,   650,    120,    20 * 60},     /* POWER_SUPPLY_TYPE_UARTOFF */
};
...
static struct battery_data_t stc3117_battery_data[] = {
		...
		.CC_cnf = 259,      /* nominal CC_cnf, coming from battery characterisation*/
		.VM_cnf = 437,      /* nominal VM cnf , coming from battery characterisation*/
		.Rint = 333,      /* nominal Rint , coming from battery characterisation*/
        ...
        .OCVValue[15] = 4162,             /* OCV curve adjustment */
        .OCVValue[14] = 4068,             /* OCV curve adjustment */
        .OCVValue[13] = 3981,             /* OCV curve adjustment */
        .OCVValue[12] = 3925,             /* OCV curve adjustment */
        .OCVValue[11] = 3893,             /* OCV curve adjustment */
        .OCVValue[10] = 3841,             /* OCV curve adjustment */
        .OCVValue[9] = 3799,              /* OCV curve adjustment */
        .OCVValue[8] = 3775,              /* OCV curve adjustment */
        .OCVValue[7] = 3756,              /* OCV curve adjustment */
        .OCVValue[6] = 3736,              /* OCV curve adjustment */
        .OCVValue[5] = 3696,              /* OCV curve adjustment */
        .OCVValue[4] = 3678,              /* OCV curve adjustment */
        .OCVValue[3] = 3651,              /* OCV curve adjustment */
        .OCVValue[2] = 3548,              /* OCV curve adjustment */
        .OCVValue[1] = 3471,              /* OCV curve adjustment */
...
static struct battery_data_t sprd2713_battery_data[] = {
{
	...
	.cnom = 1340,        /* nominal capacity in mAh */
