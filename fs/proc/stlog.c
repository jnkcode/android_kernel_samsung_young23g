...
enum ringbuf_flags {
	RINGBUF_NOCONS	= 1,	/* already flushed, do not print to console */
	RINGBUF_NEWLINE	= 2,	/* text ended with a newline */
	RINGBUF_PREFIX	= 4,	/* text started with a prefix */
	RINGBUF_CONT	= 8,	/* text is a fragment of a continuation line */
};
...
/* the next stlog record to read after the last 'clear' command */
